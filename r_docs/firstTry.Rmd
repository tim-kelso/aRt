...
generativeart::generate_img(formula = my_formula, nr_of_img = 3, polar = TRUE, filetype = "png", color = "white", background_color = "dark grey")
```

``` {r create_art2}
my_formula2 <- list(
  x = quote(runif(1, -1, 1) * x_i^4 - tan(y_i^2)),
  y = quote(runif(1, -1, 1) * y_i^3 - sin(x_i^2))
)
